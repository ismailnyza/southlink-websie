    ...
    <div className="min-h-screen flex flex-col">
      ...
      >
        ...
        <nav className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div
            className={`xl:hidden overflow-hidden transition-all ease-[cubic-bezier(0.32,0.72,0,1)] ${
              isMobileMenuOpen
          ...
          >
            <div className="pb-4 mt-2 pt-4 bg-transparent">
              <a
                ...
                className="block py-3 text-base sm:text-xl md:text-2xl text-gray-700 hover:text-primary transition-colors active:bg-gray-50 rounded-lg -mx-2 px-2"
              >
                Flights
              </a>
              <Link
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-6 sm:mb-8">
              <h3 className="text-xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-2 sm:mb-3">Southlink Travels</h3>
              <p className="text-gray-400 text-base sm:text-2xl md:text-3xl mb-3 sm:mb-4">Flights • Tours • Corporate</p>
              <p className="text-gray-500 text-sm sm:text-xl md:text-2xl">IATA Certified • Established in Galle</p>
            </div>
            <div className="flex flex-wrap justify-center gap-4 sm:gap-6 text-base sm:text-xl md:text-2xl text-gray-400 mb-6 sm:mb-8">
            ...
            <div className="text-center text-gray-500 text-sm sm:text-xl md:text-2xl">
